	...
	<div class="uk-column-1-2@l">
		...
		<div class="uk-card uk-card-default uk-margin-bottom">
			<div class="uk-card-media-top">
				<div uk-lightbox>
					<a href="img/pages/venue/Luftaufnahme_04.jpg"><img src="img/pages/venue/thumbs/Luftaufnahme_04.jpg" alt="CCH from above" /></a>
				</div>
			</div>
			<div class="uk-card-body">
				<img src="img/pages/venue/cch-logo-quer2_72dpi.jpg" alt="CCH - Congress Center Hamburg" />
				<p>
					Congressplatz 1<br />
					20355 Hamburg<br />
					Germany<br />
