...
<section>
			...
			<tfoot>
				<tr>
					<td colspan="6">
						...
						<br />
						<a href="#" uk-toggle="target: #ef-modal-dealersden-tables">⛶ Show Visualization</a>
					</td>
				</tr>
			</tfoot>
		</table>
	...
	<div id="ef-modal-dealersden-tables" class="uk-modal-container" uk-modal>
		<div class="uk-modal-dialog uk-modal-body">
			<button class="uk-modal-close-default" type="button" uk-close></button>
			<img src="img/pages/dealersden/tables.svg" alt="" />
		</div>
	</div>
...
<section class="uk-column-1-2@l">
	...
	<p>
		<ul>
			...
			<li>Covering the dealership with a tablecloth to protect goods from any dirt, dust and floating faux fur particles is recommended outside the official opening hours of the Dealers’ Den.</li>
			<li>Throughout the Dealers' Den's opening and closing hours, any tablecloth or other materials used to cover dealer tables or/and their goods must adhere to the "B1 - schwer entflammbar" (flame retardant) classification, in accordance with DIN 4102 or EN 13501-1 B - s1 d0 standards. The tablecloth needs a certificate (usually printed on the label) meeting this class. Tablecloths are not provided by Eurofurence.</li>
