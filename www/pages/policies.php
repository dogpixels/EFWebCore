...
<section>
		...
		<p>These rules and conditions apply to all attendees of the convention:</p>
		...
		<p>These rules and conditions apply only to participants of certain events:</p>
		...
		<ul>
			<li><a href="https://help.eurofurence.org/legal/statutes" target="_blank">Satzung Eurofurence e.V.</a> &ndash; Statute of the legal entity that runs the convention (German only)</li>
		</ul>
</section>
